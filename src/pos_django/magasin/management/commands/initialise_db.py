...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if Magasin.objects.count() == 0:
            ...
            self.stdout.write(self.style.SUCCESS("Magasins créés."))
        else:
            self.stdout.write("Magasins déjà créé.")
        ...
        if Produit.objects.count() == 0:
            ...
            self.stdout.write(self.style.SUCCESS("Produits créés."))
        else:
            self.stdout.write("Produits déjà créés.")
        ...
        if Stock.objects.count() == 0:
            ...
            self.stdout.write(self.style.SUCCESS("Stock ajouté au centre logistique."))
        else:
            self.stdout.write("Stock déjà créé.")
